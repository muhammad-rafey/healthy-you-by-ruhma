...
import type { FaqItem } from "@/lib/programs-data";
...
export function ProgramFaq({ items, programSlug }: ProgramFaqProps) {
  return (
    <section
      id="faq"
      aria-labelledby={`${programSlug}-faq-heading`}
