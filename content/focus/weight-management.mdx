...
The [Coaching Program](/programs/coaching) is the most direct route — a ninety-day partnership with weekly check-ins, plans that adapt as your body responds, and the support to make changes stick. If your weight is tied up with a hormonal pattern (PCOS, thyroid, post-pregnancy) the same program treats both at once.
